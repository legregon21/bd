...
/**	public static void main(String[] args) {
	...
	public JanelaCadastroPaciente(Connection conex) {
		...
		panel_1.setBounds(20, 169, 477, 79);
		...
		panel_1_1.setBounds(20, 270, 477, 39);
		...
		panel_1_1_1.setBounds(20, 327, 477, 39);
		...
		tfEmpresas_CNPJ.setBounds(70, 5, 152, 20);
		panel_1_1_1.add(tfEmpresas_CNPJ);
		
		JLabel lblRazao = new JLabel("");
		lblRazao.setBounds(242, 8, 225, 14);
		panel_1_1_1.add(lblRazao);
